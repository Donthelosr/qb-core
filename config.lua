...
QBConfig.MaxPlayers = GetConvarInt('sv_maxclients', 125) -- Gets max players from config file, default 48
QBConfig.DefaultSpawn = vector4(-538.19, -217.5, 37.65, 211.62)
...
QBConfig.Player = {}
QBConfig.Player.MaxWeight = 120 -- Max weight a player can carry (currently in pounds max weight is 100)
...
QBConfig.Server.Discord = "https://discord.gg/tibusrp" -- Discord invite link
